...
48 दस्तावेज़, 3 प्रारूप, 15 भाषाएं — Apple M-series, `--release` बिल्ड। नीचे की संख्याएँ **वास्तविक `cl100k` BPE टोकनाइज़र** (स्व-संदर्भित heuristic नहीं — विश्लेषण देखें) से मापी गई हैं। पूरी पद्धति और टोकन-ईमानदारी विवरण: [`docs/EVALUATION.md`](../EVALUATION.md)
...
> ⚠️ समग्र आंकड़ा HTML मार्कअप हटाने से प्रभावित है। **Markdown 27.4% ही वास्तविक संपीड़न दर है।** PlainText Semantic मोड में संरचनात्मक ओवरहेड के कारण शुद्ध-ऋणात्मक है। प्रारूप-वार वास्तविकता के लिए [`docs/EVALUATION.md`](../EVALUATION.md) देखें।
...
अगले सेशन स्टार्ट पर बाइनरी और PreToolUse हुक स्वचालित रूप से इंस्टॉल हो जाते हैं — कोई अतिरिक्त सेटअप आवश्यक नहीं।
...
PreToolUse हुक स्वचालित रूप से पंजीकृत होता है — कोई अतिरिक्त चरण आवश्यक नहीं।
...
रिलीज़ बिल्ड (`cargo build --release`) पर मापा गया, Apple M-series, Markdown/HTML/PlainText में 48 दस्तावेज़। सभी कमी आंकड़े **वास्तविक `cl100k` BPE टोकनाइज़र** (स्व-संदर्भित heuristic नहीं) से मापे गए हैं। पूरी पद्धति और प्रारूप-वार विवरण के लिए [`docs/EVALUATION.md`](../EVALUATION.md) देखें।

| मीट्रिक | मापा गया | नोट्स |
|---------|---------|-------|
| थ्रूपुट (केवल-Markdown शिखर) | **10,975 tok/ms** | Python पार्सिंग बेसलाइन से ≈75× तेज़; एकल-प्रारूप शिखर |
| थ्रूपुट (डेटासेट समग्र) | **~1,070 tok/ms** | सभी 48 दस्तावेज़ों / 3 प्रारूपों पर भारित (BPE) — बेंचमार्क तालिका देखें |
| Semantic कमी | **27.4%** (Markdown) | वास्तविक संपीड़न दर; 15–30% लक्ष्य श्रेणी के भीतर |
| Compressed कमी | **69.4%** (Markdown) | बजट-अनुकूली, ≥ PruneLowImportance गारंटीड |
| Lossless शब्द कवरेज | **99.0% औसत** | सभी फॉर्मेट और भाषाओं में |
| HTML कमी | **98.7%** | nav/स्क्रिप्ट/स्टाइल मार्कअप ओवरहेड हटाना दर्शाती है |
| बहुभाषी समर्थन | 15 भाषाएं परीक्षित | AR/DE/ES/FR/HI/IT/JA/KO/NL/PL/PT/RU/SV/TR/ZH — 99.0% औसत शब्द कवरेज |

मूल्यांकन सूट स्वयं चलाएं:

```bash
make eval          # संरचित JSON (BPE + heuristic; `epic eval` द्वारा उपयोग)
make eval-report   # मानव-पठनीय प्रति-फ़ाइल तालिका + सारांश
```
